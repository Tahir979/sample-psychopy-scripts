...
expName = 'replication_of_konstantinaou_beal_and_lavie_exp1a'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\wasd0\\Desktop\\Psychopy\\Konstantinaou, N., Beal, E. J. R. ve Lavie, N. (2013)\\replication_of_konstantinaou_beal_and_lavie_exp1a_lastrun.py',
...
LoopAlistirma = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('replication_of_konstantinaou_beal_and_lavie_exp1a.xlsx'),
...
for thisLoopAlistirma in LoopAlistirma:
    ...
    while continueRoutine:
        ...
        if PA2000.status == NOT_STARTED and frameN >= 0:
            # keep track of start time/frame for later
...
for thisLoopDeney in LoopDeney:
    ...
    while continueRoutine:
        ...
        if PD2000.status == NOT_STARTED and frameN >= 0:
            # keep track of start time/frame for later
